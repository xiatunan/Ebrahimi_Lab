...
e_f_t = tk.Label(root, text='data filename')
e_f_t.place(x=16, y=16, width=160, height=16)
e_f = tk.Entry(root, textvariable=varf)
e_f.place(x=16, y=32, width=160, height=16)

e_d_t = tk.Label(root, text='cols or rows')
e_d_t.place(x=16, y=48, width=160, height=16)
e_d = tk.Entry(root, textvariable=vard)
e_d.place(x=16, y=64, width=160, height=16)

e_ln_t = tk.Label(root, text='line number')
e_ln_t.place(x=16, y=80, width=160, height=16)
e_ln = tk.Entry(root, textvariable=varln)
e_ln.place(x=16, y=96, width=160, height=16)

e_h_t = tk.Label(root, text='number of header lines')
e_h_t.place(x=16, y=112, width=160, height=16)
e_h = tk.Entry(root, textvariable=varh)
e_h.place(x=16, y=128, width=160, height=16)

e_p_t = tk.Label(root, text='background line')
e_p_t.place(x=16, y=144, width=160, height=16)
e_p = tk.Entry(root, textvariable=varp)
e_p.place(x=16, y=160, width=160, height=16)

e_s_t = tk.Label(root, text='start point')
e_s_t.place(x=16, y=176, width=160, height=16)
e_s = tk.Entry(root, textvariable=varst)
e_s.place(x=16, y=192, width=160, height=16)

e_e_t = tk.Label(root, text='end point')
e_e_t.place(x=16, y=208, width=160, height=16)
e_e = tk.Entry(root, textvariable=vare)
e_e.place(x=16, y=224, width=160, height=16)

e_pa_t = tk.Label(root, text='segment number')
e_pa_t.place(x=16, y=240, width=160, height=16)
e_pa = tk.Entry(root, textvariable=varpa)
e_pa.place(x=16, y=256, width=160, height=16)
...
b_a.place(x=16, y=273, width=160, height=30)
####################
...
b_s.place(x=16, y=305, width=160, height=30)
####################
####################
e_sa_t = tk.Label(root, text='total segments')
e_sa_t.place(x=16, y=336, width=160, height=16)
varsa = tk.StringVar()
e_sa = tk.Entry(root, textvariable=varsa)
e_sa.place(x=16, y=352, width=160, height=16)
...
b_3.place(x=16, y=369, width=160, height=30)
...
b_4.place(x=16, y=401, width=160, height=30)
...
b_re.place(x=16, y=433, width=160, height=30)
####################
e_tf_t = tk.Label(root, text='name of final figure')
e_tf_t.place(x=336, y=16, width=160, height=16)
vartf = tk.StringVar()
e_tf = tk.Entry(root, textvariable=vartf)
e_tf.place(x=336, y=32, width=160, height=16)

e_xl1_t = tk.Label(root, text='lower limit of x axis')
e_xl1_t.place(x=336, y=48, width=160, height=16)
varxl1 = tk.StringVar()
e_xl1 = tk.Entry(root, textvariable=varxl1)
e_xl1.place(x=336, y=64, width=160, height=16)

e_xl2_t = tk.Label(root, text='upper limit of x axis')
e_xl2_t.place(x=336, y=80, width=160, height=16)
varxl2 = tk.StringVar()
e_xl2 = tk.Entry(root, textvariable=varxl2)
e_xl2.place(x=336, y=96, width=160, height=16)

e_yl1_t = tk.Label(root, text='lower limit of y axis')
e_yl1_t.place(x=336, y=112, width=160, height=16)
varyl1 = tk.StringVar()
e_yl1 = tk.Entry(root, textvariable=varyl1)
e_yl1.place(x=336, y=128, width=160, height=16)

e_yl2_t = tk.Label(root, text='upper limit of y axis')
e_yl2_t.place(x=336, y=144, width=160, height=16)
varyl2 = tk.StringVar()
e_yl2 = tk.Entry(root, textvariable=varyl2)
e_yl2.place(x=336, y=160, width=160, height=16)
...
b_5.place(x=336, y=177, width=160, height=30)
...
b_6.place(x=336, y=209, width=160, height=30)
####################
root.mainloop()
####################
